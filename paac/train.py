...
def get_arg_parser():
    ...
    #qbert
    #montezuma_revenge
    parser.add_argument('-g', default='riverraid', help='Name of game', dest='game')
    ...
    parser.add_argument('--max_global_steps', default=4000000, type=int, help="Max. number of training steps", dest="max_global_steps")
